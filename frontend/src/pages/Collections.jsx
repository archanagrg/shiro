        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Streetwear'} onChange={toggleCategory} /> Streetwear
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Casual'} onChange={toggleCategory} /> Casual
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Trending'} onChange={toggleCategory} /> Trending
            </p>
